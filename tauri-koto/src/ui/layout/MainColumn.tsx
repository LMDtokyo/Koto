        ...
        <div id="pane-empty" className="main-pane">
          <div id="welcome-pane" className="welcome">
            <div className="welcome__inner">
              <img className="welcome__mark" src="./assets/koto-mark.png" width={192} height={192} alt="Koto" draggable={false} />
              <h1 className="welcome__headline">Откройте чат, чтобы начать</h1>
              <p className="welcome__body">
                Все сообщения защищены сквозным шифрованием. Выберите диалог слева или создайте новый.
              </p>
            </div>
          </div>
        </div>
