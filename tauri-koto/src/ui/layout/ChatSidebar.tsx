  ...
  return (
    <aside className="sidebar chatlist-sidebar" aria-label="Список чатов">
      <nav className="sidebar-rail" aria-label="Быстрые действия">
        ...
        <div className="sidebar-rail__cluster">
          <button
            type="button"
            id="chatlist-new-chat-btn"
            className="sidebar-rail__btn sidebar-rail__btn--primary"
            title="Новый чат"
          ...
          <button
            ...
            className="sidebar-rail__btn sidebar-rail__btn--live"
            title="Друзья"
            aria-label="Друзья"
          >
            <KotoIconFriends size={22} />
          </button>
          <button type="button" id="sidebar-bots-btn" className="sidebar-rail__btn" title="Боты" aria-label="Боты">
            <KotoIconBots size={22} />
          </button>
          <button
            type="button"
            id="sidebar-camera-btn"
        ...
        <div className="chatlist-top">
          <header className="chatlist-toolbar">
            <div className="chatlist-toolbar__brand">
              ...
              <span id="chatlist-unread-badge" className="chatlist-brand-unread">
                0 новых
              </span>
            </div>
          </header>
          ...
          <div className="chatlist-tabs" role="tablist" aria-label="Фильтр чатов">
            <button type="button" className="chatlist-tab chatlist-tab--active" data-tab="all" role="tab" aria-selected="true">
              <span className="chatlist-tab__label">Все</span>
              <span className="chatlist-tab__count" data-tab-count="all" hidden>0</span>
            </button>
            <button type="button" className="chatlist-tab" data-tab="unread" role="tab" aria-selected="false" title="Непрочитанные">
              <span className="chatlist-tab__label">Непроч.</span>
              <span className="chatlist-tab__count" data-tab-count="unread" hidden>0</span>
            </button>
            <button type="button" className="chatlist-tab" data-tab="groups" role="tab" aria-selected="false">
              <span className="chatlist-tab__label">Группы</span>
              <span className="chatlist-tab__count" data-tab-count="groups" hidden>0</span>
            </button>
            <button type="button" className="chatlist-tab" data-tab="stories" role="tab" aria-selected="false" disabled title="Скоро">
              <span className="chatlist-tab__label">Истории</span>
            </button>
          </div>
